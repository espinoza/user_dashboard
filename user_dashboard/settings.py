...
SECRET_KEY = 'hc-**wlnz($_yq$*(u-y1+=zo83b(db^xko$2zv$jfo4o9niaf'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'user_dashboard1', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
